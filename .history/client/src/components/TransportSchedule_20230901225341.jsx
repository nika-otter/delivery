      ...
      <div className="grid grid-cols-1 gap-4">
        <div>
          ...
          >
            ...
            {transports.map((transport) => (
              <option key={transport.id} value={transport.shipped_date}>
        ...
        <div>
          ...
          >
            ...
            {console.log("selectedTransport", selectedTransport.location_id)}
            {gates
              .filter(
                (gate) => gate.location_id === selectedTransport.locatio_id
              )
              .map((gate) => (
